...
#rename columns
colnames(NIH_data_main) <- c('Fiscal_Year', 'Award_Amount', 'Status', 'PIs', 'PI', 'Start_Date', 'End_Date', 'Is_New', 'Program_Name', 'Source', 'Institution')
...
#NSF_data_main <- NSF_data_main[complete.cases(NSF_data_main$'Start Date', NSF_data_main$'End Date'), ]
...
#Q2_1 <- combine the two above


#ggplot(Q2_1, aes(x = Start.year , y = n, color = Source, linetype = source)) + 
  #geom_line(size = 1) +
  #scale_color_manual(values = ) +
  #scale_linetype_manual(values = ) +
  #labs(title = "Number of New Awards",
      # x = "Year",
